...
A component can have modifiers (`form__input` can have a modifier class of `form__input--inline`) and you CAN package your modifiers into your component, but with great power comes great responsibity. Only add modifiers to your component that are not site specific and are likely to crop up again and again.
